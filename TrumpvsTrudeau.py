...
plot_confusion_matrix(tfidf_nb_cm, classes=tfidf_nb_cm, title="TF-IDF NB Confusion Matrix")

# Plot the count_nb_cm confusion matrix without overwriting the first plot 
plot_confusion_matrix(count_nb_cm, classes=count_nb_cm, title="Count NB Confusion Matrix ", figure=1)
...
plot_confusion_matrix(svc_cm, classes=svc_cm, title="TF-IDF LinearSVC Confusion Matrix")
